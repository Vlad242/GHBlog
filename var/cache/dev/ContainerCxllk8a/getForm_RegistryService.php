...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Geek\\BlogBundle\\Form\\NewCommentType' => function () {
    return ${($_ = isset($this->services['Geek\BlogBundle\Form\NewCommentType']) ? $this->services['Geek\BlogBundle\Form\NewCommentType'] : $this->services['Geek\BlogBundle\Form\NewCommentType'] = new \Geek\BlogBundle\Form\NewCommentType()) && false ?: '_'};
}, 'Geek\\BlogBundle\\Form\\NewPostType' => function () {
    return ${($_ = isset($this->services['Geek\BlogBundle\Form\NewPostType']) ? $this->services['Geek\BlogBundle\Form\NewPostType'] : $this->services['Geek\BlogBundle\Form\NewPostType'] = new \Geek\BlogBundle\Form\NewPostType()) && false ?: '_'};
}, 'Geek\\BlogBundle\\Form\\NewUserType' => function () {
    return ${($_ = isset($this->services['Geek\BlogBundle\Form\NewUserType']) ? $this->services['Geek\BlogBundle\Form\NewUserType'] : $this->services['Geek\BlogBundle\Form\NewUserType'] = new \Geek\BlogBundle\Form\NewUserType()) && false ?: '_'};
}, 'Geek\\BlogBundle\\Form\\SearchType' => function () {
    return ${($_ = isset($this->services['Geek\BlogBundle\Form\SearchType']) ? $this->services['Geek\BlogBundle\Form\SearchType'] : $this->services['Geek\BlogBundle\Form\SearchType'] = new \Geek\BlogBundle\Form\SearchType()) && false ?: '_'};
}, 'Geek\\BlogBundle\\Form\\UpdatePostType' => function () {
    return ${($_ = isset($this->services['Geek\BlogBundle\Form\UpdatePostType']) ? $this->services['Geek\BlogBundle\Form\UpdatePostType'] : $this->services['Geek\BlogBundle\Form\UpdatePostType'] = new \Geek\BlogBundle\Form\UpdatePostType()) && false ?: '_'};
