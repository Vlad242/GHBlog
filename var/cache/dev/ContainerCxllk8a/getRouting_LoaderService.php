...
$g->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($a));
...
$g->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($a, $e, true, array('json' => false, 'xml' => false, 'html' => true), 'json'));
$g->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($a, $e, true, array('json' => false, 'xml' => false, 'html' => true), 'json'));
$g->addLoader($f);
