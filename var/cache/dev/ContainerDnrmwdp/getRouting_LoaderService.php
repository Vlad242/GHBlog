...
$g->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($a, $e, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$g->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($a, $e, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$g->addLoader($f);
