...
include_once $this->targetDirs[3].'/src/Geek/BlogBundle/DataFixtures/ORM/ThemesFixtures.php';
...
$a->addFixtures(array(0 => new \Geek\BlogBundle\DataFixtures\ORM\CommentsFixtures(), 1 => new \Geek\BlogBundle\DataFixtures\ORM\PostsFixtures(), 2 => new \Geek\BlogBundle\DataFixtures\ORM\TagsFixtures(), 3 => new \Geek\BlogBundle\DataFixtures\ORM\ThemesFixtures(), 4 => new \Geek\BlogBundle\DataFixtures\ORM\UsersFixtures(${($_ = isset($this->services['security.password_encoder']) ? $this->services['security.password_encoder'] : $this->load(__DIR__.'/getSecurity_PasswordEncoderService.php')) && false ?: '_'})));
