...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            ...
            'security.authentication.listener.anonymous.unsec' => __DIR__.'/getSecurity_Authentication_Listener_Anonymous_UnsecService.php',
            ...
            'security.authentication.provider.anonymous.unsec' => __DIR__.'/getSecurity_Authentication_Provider_Anonymous_UnsecService.php',
            ...
            'security.firewall.map.context.unsec' => __DIR__.'/getSecurity_Firewall_Map_Context_UnsecService.php',
            ...
            'security.request_matcher.nybp4pi' => __DIR__.'/getSecurity_RequestMatcher_Nybp4piService.php',
        ...
        $this->privates = array(
            ...
            'security.authentication.listener.anonymous.unsec' => true,
            'security.authentication.listener.form.main' => true,
            'security.authentication.manager' => true,
            'security.authentication.provider.anonymous.main' => true,
            'security.authentication.provider.anonymous.unsec' => true,
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hSfNAOo1Ki', 0, '0F-aKF-oY+kH36MtKp35Qg', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9BNnelSZ4u', 0, '0F-aKF-oY+kH36MtKp35Qg', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UEW2R4lYeW', 0, '0F-aKF-oY+kH36MtKp35Qg', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D8syEBRNGq', 0, '0F-aKF-oY+kH36MtKp35Qg', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['security.authentication.provider.anonymous.unsec']) ? $this->services['security.authentication.provider.anonymous.unsec'] : $this->services['security.authentication.provider.anonymous.unsec'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a7896c04b1230.13672161')) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['security.authentication.provider.dao.main']) ? $this->services['security.authentication.provider.dao.main'] : $this->load(__DIR__.'/getSecurity_Authentication_Provider_Dao_MainService.php')) && false ?: '_'};
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.dev' => function () {
        ...
        }, 'security.firewall.map.context.unsec' => function () {
            return ${($_ = isset($this->services['security.firewall.map.context.unsec']) ? $this->services['security.firewall.map.context.unsec'] : $this->load(__DIR__.'/getSecurity_Firewall_Map_Context_UnsecService.php')) && false ?: '_'};
            ...
            yield 'security.firewall.map.context.unsec' => ${($_ = isset($this->services['security.request_matcher.nybp4pi']) ? $this->services['security.request_matcher.nybp4pi'] : $this->services['security.request_matcher.nybp4pi'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(login|register)$')) && false ?: '_'};
