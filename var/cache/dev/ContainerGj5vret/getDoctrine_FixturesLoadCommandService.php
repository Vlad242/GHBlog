...
$a->addFixtures(array(0 => new \Geek\BlogBundle\DataFixtures\ORM\PostsFixtures(), 1 => new \Geek\BlogBundle\DataFixtures\ORM\TagsFixtures(), 2 => new \Geek\BlogBundle\DataFixtures\ORM\ThemesFixtures(), 3 => new \Geek\BlogBundle\DataFixtures\ORM\UsersFixtures(${($_ = isset($this->services['security.password_encoder']) ? $this->services['security.password_encoder'] : $this->load(__DIR__.'/getSecurity_PasswordEncoderService.php')) && false ?: '_'})));
