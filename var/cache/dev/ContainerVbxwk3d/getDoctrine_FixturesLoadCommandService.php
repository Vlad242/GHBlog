...
include_once $this->targetDirs[3].'/src/Geek/BlogBundle/DataFixtures/PostsFixtures.php';
include_once $this->targetDirs[3].'/src/Geek/BlogBundle/DataFixtures/TagsFixtures.php';
include_once $this->targetDirs[3].'/src/Geek/BlogBundle/DataFixtures/ThemesFixtures.php';
...
$a->addFixtures(array(0 => new \Geek\BlogBundle\DataFixtures\PostsFixtures(), 1 => new \Geek\BlogBundle\DataFixtures\TagsFixtures(), 2 => new \Geek\BlogBundle\DataFixtures\ThemesFixtures()));
