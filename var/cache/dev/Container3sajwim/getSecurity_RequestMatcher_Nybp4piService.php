...
// Returns the private 'security.request_matcher.nybp4pi' shared service.
...
return $this->services['security.request_matcher.nybp4pi'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(login|register)$');
