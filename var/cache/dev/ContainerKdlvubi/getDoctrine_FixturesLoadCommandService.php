...
include_once $this->targetDirs[3].'/src/Geek/BlogBundle/DataFixtures/ThemeFixtures.php';
...
$a->addFixtures(array(0 => new \Geek\BlogBundle\DataFixtures\TagsFixtures(), 1 => new \Geek\BlogBundle\DataFixtures\ThemeFixtures()));
